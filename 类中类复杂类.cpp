...
public:
	...
	Point GetUpperLeft() const {return itsUpperLeft;}//访问函数，为了访问并输出私有类成员itsUpperLeft等四个
...
int main()
{
	...
	cout <<MyRectangle.GetUpperLeft().GetX()<<endl;//输出20.。
...
//Point的对象，才能接着访问Point的公有函数return出itsX!